...
$case_studies_hero_eyebrow = get_field('case_studies_hero_eyebrow', 'option') ?? null;
$case_studies_hero_heading = get_field('case_studies_hero_heading', 'option') ?? null;
$case_studies_hero_copy = get_field('case_studies_hero_copy', 'option') ?? null;
 ...
 ?>
	 ...
	 <main id="primary" class="site-main">
		 ...
		 <?php if($case_studies_hero_eyebrow || $case_studies_hero_heading || $case_studies_hero_copy):?>
