(() => {
  ...
  // source/js/app.js
  window.jQuery = import_jquery15.default;
  window.$ = import_jquery15.default;
  Foundation.addToJquery(import_jquery15.default);
  Foundation.Box = Box;
  ...
  MediaQuery._init();
  Triggers.init(import_jquery15.default, Foundation);
  (0, import_jquery15.default)(function() {
    "use strict";
    (0, import_jquery15.default)(document).foundation();
    hasScrolled();
    headerHeight();
  });
})();
