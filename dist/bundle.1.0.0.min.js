(() => {
    ...
    window.addEventListener("resize", () => {
      ...
      resizeTimer = setTimeout(() => {
        if (window.innerWidth > 900 && target.classList.contains("is-open")) {
          (0, import_jquery15.default)(target).foundation("close");
        }
      }, 100);
    });
  }
  ...
  // source/js/app.js
  var jQueryInstance = window.jQuery || import_jquery16.default;
  ...
  (0, import_jquery16.default)(function() {
    "use strict";
    MediaQuery._init();
    const isEditor = (0, import_jquery16.default)("body").hasClass("block-editor-page") || (0, import_jquery16.default)("body").hasClass("wp-admin");
    if (!isEditor) {
      Triggers.init(import_jquery16.default, Foundation);
    }
    (0, import_jquery16.default)(document).foundation();
    hasScrolled();
