...
add_action('init', function() {
	...
	register_block_pattern(
			'my-theme/post-detail-layout',
			array(
				'title'       => __('Post Detail Layout', 'my-theme'),
				'description' => __('A full post detail layout including breadcrumbs, title, content wrappers, and related posts.', 'my-theme'),
				'categories'  => array('custom-page-templates'), // Updated category slug here
				'content'     => '<!-- wp:acf/breadcrumbs {"name":"acf/breadcrumbs","mode":"preview","backgroundColor":"bith-white"} /-->
	...
	<!-- wp:acf/centered-green-radial-gradient-cta-banner {"name":"acf/centered-green-radial-gradient-cta-banner","data":{"use_global_values":"1","_use_global_values":"field_6a0a35c6c394c"},"mode":"preview"} /-->',
			)
		);
